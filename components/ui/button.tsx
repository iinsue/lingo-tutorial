...
const buttonVariants = cva(
  ...
  text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none
  ...
  disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide`,
  {
    variants: {
      variant: {
        default:
          "bg-white text-slate-500 border-slate-200 border-2 border-b-[4px] active:border-b-2 hover:bg-slate-100",
        primary:
